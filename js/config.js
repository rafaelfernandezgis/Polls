...
dojo.declare("js.Config", null, {
    ...
    ApplicationName: "2013 Election Polling Stations",

    // Set application icon path
    ApplicationIcon: "images/election_logo.png",

    // Set splash window content - Message that appears when the application starts
    SplashScreenMessage: "<b>Election Polling Stations</b> <br/> <hr/> <br/> The <b>Election Polling Stations</b> application helps citizens locate their election polling station. To locate a polling place, simply click on the map or enter an address in the search box.  The polling station and respective voting precinct will then be highlighted on the map and information about the polling place and elected officials displayed in two tabs along the bottom of the map.<br/><br/>",
	...
	DefaultExtent: "316000,5260000,330000,5274000",
    ...
    PollLayer: {
		...
		ServiceUrl: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/PollingPlaces/FeatureServer/0",
    ...
    PrecinctLayer: {
		ServiceUrl: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/Precints_CSJ/FeatureServer/0",
        //ServiceUrl: "http://map.stjohns.ca/Arcgis/rest/services/MapCentre/STJ_MC_Wards_MapService/MapServer",
        Color: "#eded93",
        Alpha: 0.5,
        UseColor: true
    },

    PrecinctOfficeLayer: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/PollingPlaces/FeatureServer/1",
    ...
    PollingCommentsLayer: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/PollingPlaces/FeatureServer/2",
    ...
    ElectedOfficialsTabData: {
		Mayor: {
			ServiceUrl: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/Precints_CSJ/FeatureServer/1",
            HeaderColor: "#303030",
            Title: "<b>Mayor</b>",
            Data: [{
        ...
        Ward: {
			ServiceUrl: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/Precints_CSJ/FeatureServer/2",
            HeaderColor: "#303030",
            Title: "<b>Ward</b>",
            Data: [{
                DisplayText: "Ward:",
        ...
        At_Large: {
			ServiceUrl: "http://services1.arcgis.com/ujp4AeSs32zPJZBw/arcgis/rest/services/Precints_CSJ/FeatureServer/3",
            HeaderColor: "#303030",
            Title: "<b>At Large</b>",
            Data: [{
