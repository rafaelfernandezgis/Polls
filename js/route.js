...
function ShowRoute(solveResult) {
    ...
    if (divDirections) {
        ...
        tdTotalDistance.innerHTML = "Total Distance: " + FormatDistance(directions.totalLength, "kilometers");
    ...
    if (divDirections) {
        ...
        for (var i in solveResult.routeResults[0].directions.features) {
            ...
            var kilometers = FormatDistance(feature.attributes.length, "kilometers");
            ...
            if (i == 0) {
                ...
                if (kilometers) {
                    td.innerHTML = feature.attributes.text + " (" + FormatDistance(feature.attributes.length, "kilometers") + ")";
                }
                else {
